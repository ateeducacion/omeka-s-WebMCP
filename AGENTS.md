...
Read [webmcp-proxy](.agents/skills/webmcp-proxy/SKILL.md) when you need to: change browser tools or the admin WebMCP proxy, including batch operations and metadata writes.
